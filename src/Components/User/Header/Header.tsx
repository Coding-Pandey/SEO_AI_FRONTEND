            ...
            <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
              ...
              <li>
                <Link
                  to="/profile-setting"
                  className={`nav-link ${
                    isActive("/profile-setting") ? "active" : ""
                  }`}
                >
                    ...
                    <li className="nav-item dropdown">
                      ...
                      <ul className="dropdown-menu">
                        ...
                        <li className="dropdown-item">
                          <Link
                            className={`submenu-link ${
                              isActive("/seo/keyword-tool") ? "active" : ""
                            }`}
                            to="/seo/keyword-tool"
                          >
                            Keyword tool
                    ...
                    <li className="nav-item dropdown">
                      ...
                      <ul className="dropdown-menu">
                        ...
                        <li className="dropdown-item">
                          <Link
                            className={`submenu-link ${
                              isActive("/ppc/create-campaign") ? "active" : ""
                            }`}
                            to="/ppc/create-campaign"
                          >
                            Create Campaign
                          </Link>
                        </li>
                    ...
                    <li className="nav-item dropdown">
                      ...
                      <ul className="dropdown-menu">
                        ...
                        <li className="dropdown-item">
                          <Link
                            className={`submenu-link ${
                              isActive("/social/generate-post") ? "active" : ""
                            }`}
                            to="/social/generate-post"
                          >
                            Generate Post
                          </Link>
                        </li>
                    ...
                    <li className="nav-item dropdown">
                      ...
                      <ul className="dropdown-menu">
                        ...
                        <li className="dropdown-item">
                          <Link
                            className={`submenu-link ${
                              isActive("/content/content-generation")
                                ? "active"
                                : ""
                            }`}
                            to="/content/content-generation"
                          >
                            Content Generation
                          </Link>
                        </li>
